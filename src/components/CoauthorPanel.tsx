    ...
    try {
      ...
      const response = await fetch("/api/coauthor/runs", {
        ...
        body: JSON.stringify({
          ...
          options: { humanizeDepth: "balanced", model: selectedModel },
          llmProvider,
